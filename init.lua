...
minetest.register_node("player_light:torchlight", {
	drawtype = "airlike",
...
local function is_torchlight(pos)
	...
	return node.name == "player_light:torchlight"
end
...
local function place_torchlight(pos)
	...
	if name == "player_light:torchlight" then
		return true
	end
	...
	if name == "air" then
		minetest.swap_node(pos, {name = "player_light:torchlight"})
		return true
	end
	return false
end
